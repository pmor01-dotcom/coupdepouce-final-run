...
export default function ArtisanDashboard() {
  ...
  if (!user) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-green-700 to-green-200">
  ...
  if (isLoading) {
    return (
      <main className="min-h-screen bg-gradient-to-b from-green-700 to-green-200 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            <button
              ...
              className={`flex-1 min-w-[140px] px-5 py-3 rounded-xl text-sm sm:text-base font-medium transition-all ${
                activeTab === 'jobs'
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm text-gray-600 mb-4">
                          <div className="bg-white p-2 rounded-lg">
                            <span className="font-medium text-gray-700">📍 Localisation:</span> {job.location}
                          </div>
                          <div className="bg-white p-2 rounded-lg">
                            <span className="font-medium text-gray-700">🏢 Département:</span> {job.department}
                          </div>
                          <div className="bg-white p-2 rounded-lg">
                            <span className="font-medium text-gray-700">💰 Budget:</span> {job.budget_range}
                          </div>
                          <div className="bg-white p-2 rounded-lg">
                            <span className="font-medium text-gray-700">⚡ Urgence:</span> {job.urgency}
                          </div>
                        </div>
                        ...
                        <Link
                          href={`/artisan/propose/${job.id}`}
                          className="flex-1 min-w-[140px] px-5 py-3 rounded-xl text-sm sm:text-base font-medium transition-all bg-white/70 text-gray-700 hover:bg-white inline-block"
                        >
