    ...
    <MessagingProvider>
      ...
      >
        ...
        <header className="bg-white shadow-sm border-b">
          <div className="max-w-3xl mx-auto px-4">
            <div className="flex items-center justify-center h-20">
              <h1 className="text-4xl font-bold text-gray-900">Espace Client</h1>
            </div>
          </div>
        </header>
        ...
        <div className="max-w-3xl mx-auto px-4 mt-6 flex flex-col gap-3 w-full">
            ...
            <Link href="/client-dashboard/demandes" className="bg-gray-500 hover:bg-gray-600 text-white px-4 py-3 rounded-lg text-sm font-medium transition-colors cursor-pointer w-full text-center block">
              Mes demandes
            </Link>
