      ...
      >
        ...
        <div className="max-w-3xl mx-auto px-4 mt-6">
          <div className="flex flex-col gap-3 w-full">
            ...
            <Link href="/client-dashboard/demandes" className="bg-gray-500 hover:bg-gray-600 text-white px-4 py-3 rounded-lg text-sm font-medium transition-colors cursor-pointer w-full text-center">
              Mes demandes
            </Link>
