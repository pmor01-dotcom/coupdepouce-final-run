    ...
    <MessagingProvider>
      ...
      >
        ...
        <div className="fixed right-4 top-1/2 transform -translate-y-1/2 flex flex-col gap-3 z-50">
          ...
          <Link href="/client-dashboard/demandes" className="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors cursor-pointer whitespace-nowrap text-center">
            Mes demandes
          </Link>
